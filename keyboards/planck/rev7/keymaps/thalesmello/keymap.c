...
enum planck_layers { _QWERTY, _COLEMAK, _DVORAK, _LOWER, _RAISE, _SPACE, _ADJUST, _FN, _FNEXTRA };

enum planck_keycodes { QWERTY = SAFE_RANGE, COLEMAK, DVORAK };
...
[_QWERTY] = LAYOUT_planck_grid(
        ...
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,       KC_T,    KC_Y,              KC_U,           KC_I,    KC_O,    KC_P,    KC_BSPC,
        KC_ESC,  KC_A,    KC_S,    KC_D,    KC_F,       KC_G,    KC_H,              KC_J,           KC_K,    KC_L,    KC_SCLN, KC_QUOT,
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,       KC_B,    KC_N,              KC_M,           KC_COMM, KC_DOT,  KC_SLSH, LT(_RAISE,KC_ENT),
        KC_LCTL, MO(_FN), KC_LALT, KC_LGUI, MO(_RAISE), KC_RALT, LT(_SPACE,KC_SPC), LOWER_OSM_RALT, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
...
[_LOWER] = LAYOUT_planck_grid(
        ...
        _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, KC_PGDN,    KC_PGUP, KC_HOME, KC_END,  _______,
        _______, _______, _______, _______, MO(_ADJUST), _______, _______, TG(_LOWER), KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_RAISE] = LAYOUT_planck_grid(
        ...
        _______, _______, _______, _______, _______, MO(_ADJUST), _______, MO(_ADJUST), XXXXXXX, KC_BRID, KC_BRIU, XXXXXXX
),
...
[_FN] = LAYOUT_planck_grid(
        ...
        LGUI(KC_GRV), KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  XXXXXXX,
        XXXXXXX,      KC_F11,  KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        XXXXXXX,      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
        MO(_FNEXTRA), _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
),

[_FNEXTRA] = LAYOUT_planck_grid(
        /* _______, QK_BOOT, DB_TOGG, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_DEL , */
        /* _______, EE_CLR,  MU_NEXT, AU_ON,   AU_OFF,  AG_NORM, AG_SWAP, QWERTY,  COLEMAK, DVORAK,  PLOVER,  _______, */
        /* _______, AU_PREV, AU_NEXT, MU_ON,   MU_OFF,  MI_ON,   MI_OFF,  _______, _______, _______, _______, _______, */
        /* _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______ */
